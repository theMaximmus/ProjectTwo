...
public class CourseTester {
	...
	public static void testAddMethod(Student student, Course course, boolean expectedRosterResult, boolean expectedWaitlistResult, String testDescription) {
		...
		int beforeRosterSize = course.getCurrentStudentsEnrolled();
		int beforeWaitlistSize = course.getCurrentStudentsOnWaitlist();
		...
		int afterRosterSize = course.getCurrentStudentsEnrolled();
		int afterWaitlistSize = course.getCurrentStudentsOnWaitlist();
